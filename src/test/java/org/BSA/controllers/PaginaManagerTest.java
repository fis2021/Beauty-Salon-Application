...
class PaginaManagerTest {
    ...
    void start(Stage primaryStage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("paginaManager.fxml"));
    ...
    void testPaginaManager(FxRobot robot) {
        robot.clickOn("#VizualizareListaClientiInAsteptare");
        robot.clickOn("#inapoi1");
        robot.clickOn("#AcceptareRespingereProgramare");
        robot.clickOn("#inapoi2");
        robot.clickOn("#AdaugareServiciiSiPreturi");
