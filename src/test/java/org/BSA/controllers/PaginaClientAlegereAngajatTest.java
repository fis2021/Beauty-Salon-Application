...
class PaginaClientAlegereAngajatTest {
    ...
    @Test
    void testPaginaClientAlegereAngajat(FxRobot robot) throws UsernameAlreadyExistsException {
        ...
        robot.clickOn("#angajat");
        robot.clickOn("Voicu Andra-Makeup");
        robot.clickOn("#ora");
        robot.clickOn("10:00");
        robot.clickOn("#selectare");
